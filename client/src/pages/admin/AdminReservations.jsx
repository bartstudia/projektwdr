...
const AdminReservations = () => {
  ...
  const handleCancelReservation = async (reservationId) => {
    if (!window.confirm('Czy na pewno chcesz anulowac ta rezerwacje?')) {
      return;
    }
    ...
    try {
      ...
      alert(err.message || 'Blad podczas anulowania rezerwacji');
    }
  };
                ...
                <tr key={reservation._id}>
                  ...
                  <td>
                    {reservation.status !== 'cancelled' ? (
                      ...
                      <span className="text-muted">Anulowana</span>
                    )}
                  </td>
                </tr>
              ))}
